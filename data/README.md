...
| File | Rows | Contents |
| --- | ---: | --- |
| `events_index.csv` | 9,410 | one row per open event, plain CSV |
| `events_index.csv.gz` | 9,410 | the same rows, gzip |
| `markets_index.csv.gz` | 72,482 | one row per market |
| `series_rollup.csv` | 3,128 | per-series counts aggregated from the market index |
